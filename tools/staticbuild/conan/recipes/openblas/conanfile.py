...
class openblasConan(ConanFile):
    name = "openblas"
    version = "4a4c50a7cef9fa91f14e508722f502d956ad5192"
    ...
    default_options = "shared=False", "USE_MASS=False", "USE_OPENMP=False", "NO_LAPACKE=True", "NOFORTRAN=False", "DYNAMIC_ARCH=True", "FLANG=True"
    ...
    def source(self):
        ...
        tools.get("https://github.com/xianyi/OpenBLAS/archive/4a4c50a7cef9fa91f14e508722f502d956ad5192.zip",
                  sha256="e47f46b3b592533503370cc4cbbd5202e6e2be4caa176bb971cfa312eb711bda")
        os.rename("OpenBLAS-4a4c50a7cef9fa91f14e508722f502d956ad5192", "sources")
    ...
    def _build_make(self, args=None):
        make_options = ["DEBUG=%s" % self._get_make_build_type_debug(),
                        ...
                        "DYNAMIC_ARCH=%s" % self._get_make_option_value(self.options.DYNAMIC_ARCH),
        ...
        if self.settings.os == "Linux" and self.options.FLANG:
            make_options += ["FC=flang"]
